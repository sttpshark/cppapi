//******************************************************************************************************
//  SecureSubscriberConnection.cpp - Gbtc
//
...
SecureSubscriberConnection::SecureSubscriberConnection(DataPublisherPtr parent, IOContext& commandChannelService) : //NOLINT
    ...
    m_stopped(true),
    m_commandChannelSocket(m_commandChannelService), // Start Ssl
    m_commandSslContext(boost::asio::ssl::context::sslv23),
    m_commandSslSocket(m_commandChannelSocket, m_commandSslContext),
    ...
    m_tsscSequenceNumber(0)
{
    ...
    m_pingTimer.SetCallback(&SecureSubscriberConnection::PingTimerElapsed);
    m_pingTimer.SetUserData(this);
}

SecureSubscriberConnection::~SecureSubscriberConnection() = default;

const DataPublisherPtr& SecureSubscriberConnection::GetParent() const
{
    return m_parent;
}

SecureSubscriberConnectionPtr SecureSubscriberConnection::GetReference()
{
...
void SecureSubscriberConnection::SetSubscriberID(const sttp::Guid& id)
{
    m_subscriberID = id;
}

const sttp::Guid& SecureSubscriberConnection::GetInstanceID() const
{
    return m_instanceID;
}

const string& SecureSubscriberConnection::GetConnectionID() const
{
    return m_connectionID;
}

const sttp::IPAddress& SecureSubscriberConnection::GetIPAddress() const
{
    return m_ipAddress;
}

const string& SecureSubscriberConnection::GetHostName() const
{
    return m_hostName;
}

uint32_t SecureSubscriberConnection::GetOperationalModes() const
{
    return m_operationalModes;
}

void SecureSubscriberConnection::SetOperationalModes(const uint32_t value)
{
    m_operationalModes = value;
    m_encoding = value & OperationalModes::EncodingMask;
}

uint32_t SecureSubscriberConnection::GetEncoding() const
{
    return m_encoding;
}

bool SecureSubscriberConnection::GetIsTemporalSubscription() const
{
    return m_startTimeConstraint < DateTime::MaxValue;
}

const sttp::datetime_t& SecureSubscriberConnection::GetStartTimeConstraint() const
{
    return m_startTimeConstraint;
}

void SecureSubscriberConnection::SetStartTimeConstraint(const sttp::datetime_t& value)
{
    m_startTimeConstraint = value;
}

const sttp::datetime_t& SecureSubscriberConnection::GetStopTimeConstraint() const
{
    return m_stopTimeConstraint;
}

void SecureSubscriberConnection::SetStopTimeConstraint(const sttp::datetime_t& value)
{
    m_stopTimeConstraint = value;
}

int32_t SecureSubscriberConnection::GetProcessingInterval() const
{
    return m_processingInterval;
}

void SecureSubscriberConnection::SetProcessingInterval(const int32_t value)
{
...
bool SecureSubscriberConnection::GetUsingPayloadCompression() const
{
    return m_usingPayloadCompression;
}

bool SecureSubscriberConnection::GetUsingCompactMeasurementFormat() const
{
    return !m_usingPayloadCompression;
}

bool SecureSubscriberConnection::GetIncludeTime() const
{
    return m_includeTime;
}

void SecureSubscriberConnection::SetIncludeTime(const bool value)
{
    m_includeTime = value;
}

bool SecureSubscriberConnection::GetUseLocalClockAsRealTime() const
{
    return m_useLocalClockAsRealTime;
}

void SecureSubscriberConnection::SetUseLocalClockAsRealTime(const bool value)
{
    m_useLocalClockAsRealTime = value;
}

float64_t SecureSubscriberConnection::GetLagTime() const
{
    return m_lagTime;
}

void SecureSubscriberConnection::SetLagTime(const float64_t value)
{
    m_lagTime = value;
}

float64_t SecureSubscriberConnection::GetLeadTime() const
{
    return m_leadTime;
}

void SecureSubscriberConnection::SetLeadTime(const float64_t value)
{
    m_leadTime = value;
}

float64_t SecureSubscriberConnection::GetPublishInterval() const
{
    return m_publishInterval;
}

void SecureSubscriberConnection::SetPublishInterval(const float64_t value)
{
    m_publishInterval = value;
}

bool SecureSubscriberConnection::GetUseMillisecondResolution() const
{
    return m_useMillisecondResolution;
}

void SecureSubscriberConnection::SetUseMillisecondResolution(const bool value)
{
    m_useMillisecondResolution = value;
}

bool SecureSubscriberConnection::GetTrackLatestMeasurements() const
{
    return m_trackLatestMeasurements;
}

void SecureSubscriberConnection::SetTrackLatestMeasurements(const bool value)
{
    m_trackLatestMeasurements = value;
}

bool SecureSubscriberConnection::GetIsNaNFiltered() const
{
    return m_isNaNFiltered;
}

void SecureSubscriberConnection::SetIsNaNFiltered(const bool value)
{
    if (value)
    {
...
bool SecureSubscriberConnection::GetIsSubscribed() const
{
    return m_isSubscribed;
}

void SecureSubscriberConnection::SetIsSubscribed(const bool value)
{
    m_isSubscribed = value;
}

const string& SecureSubscriberConnection::GetSubscriptionInfo() const
{
    return m_subscriptionInfo;
}

void SecureSubscriberConnection::SetSubscriptionInfo(const string& value)
{
    if (value.empty())
    {
...
const SignalIndexCachePtr& SecureSubscriberConnection::GetSignalIndexCache()
{
...
void SecureSubscriberConnection::SetSignalIndexCache(SignalIndexCachePtr signalIndexCache)
{
...
uint64_t SecureSubscriberConnection::GetTotalCommandChannelBytesSent() const
{
    return m_totalCommandChannelBytesSent;
}

uint64_t SecureSubscriberConnection::GetTotalDataChannelBytesSent() const
{
    return m_totalDataChannelBytesSent;
}

uint64_t SecureSubscriberConnection::GetTotalMeasurementsSent() const
{
    return m_totalMeasurementsSent;
}

bool SecureSubscriberConnection::CipherKeysDefined() const
{
    return !m_keys[0].empty();
}

vector<uint8_t> SecureSubscriberConnection::Keys(const int32_t cipherIndex)
{
...
vector<uint8_t> SecureSubscriberConnection::IVs(const int32_t cipherIndex)
{
    if (cipherIndex < 0 || cipherIndex > 1)
        throw out_of_range("Cipher index must be 0 or 1");
...
void SecureSubscriberConnection::Start(const bool connectionAccepted)
{
...
void SecureSubscriberConnection::Stop(const bool shutdownSocket)
{
    if (m_stopped)
        return;
...
void SecureSubscriberConnection::PublishMeasurements(const vector<MeasurementPtr>& measurements)
{
...
void SecureSubscriberConnection::CancelTemporalSubscription()
{
...
void SecureSubscriberConnection::HandleSubscribe(uint8_t* data, uint32_t length)
{
    try
    {
        if (length >= 6)
                    ...
                    if (TryGetValue(settings, "dataChannel", setting))
                    {
                        ...
                        if (TryGetValue(settings, "port", setting) || TryGetValue(settings, "localport", setting))
                        {
                            ...
                            if (TryParseUInt16(setting, m_udpPort))
                            {
                                ...
                                // TLS for m_dataChannelSocket
                                m_dataChannelSocket.set_verify_mode(boost::asio::ssl::verify_peer);
                                m_context.load_verify_file(m_ca);
                                ...
                                boost::asio::asyc_connect(m_dataChannelSocket.lowest_layer, udp::endpoint(remoteEndPoint.address(), m_udpPort),
                                    [this](const boost::system::error_code& error,const tcp::endpoint& /*endpoint*/)
                                    {
                                        if (!error)
                                        {
                                            m_dataChannelSocket.async_hadnshake(boost::asio::ssl::stream_base::client,
...
void SecureSubscriberConnection::HandleSubscribeFailure(const std::string& message)
{
...
void SecureSubscriberConnection::HandleUnsubscribe()
{
...
void SecureSubscriberConnection::HandleMetadataRefresh(uint8_t* data, uint32_t length)
{
...
void SecureSubscriberConnection::HandleRotateCipherKeys()
{
}

void SecureSubscriberConnection::HandleUpdateProcessingInterval(const uint8_t* data, const uint32_t length)
{
...
void SecureSubscriberConnection::HandleDefineOperationalModes(uint8_t* data, const uint32_t length)
{
    if (length < 4)
        return;
...
void SecureSubscriberConnection::HandleUserCommand(const uint32_t command, uint8_t* data, const uint32_t length)
{
    m_parent->DispatchUserCommand(m_parent->AddDispatchReference(GetReference()), command, data, length);
}

SignalIndexCachePtr SecureSubscriberConnection::ParseSubscriptionRequest(const string& filterExpression, bool& success)
{
...
void SecureSubscriberConnection::PublishCompactMeasurements(const std::vector<MeasurementPtr>& measurements)
{
...
void SecureSubscriberConnection::PublishCompactDataPacket(const vector<uint8_t>& packet, const int32_t count)
{
    vector<uint8_t> buffer;
...
void SecureSubscriberConnection::PublishTSSCMeasurements(const std::vector<MeasurementPtr>& measurements)
{
    const SignalIndexCachePtr signalIndexCache = GetSignalIndexCache();
...
void SecureSubscriberConnection::PublishTSSCDataPacket(const int32_t count)
{
...
bool SecureSubscriberConnection::SendDataStartTime(const uint64_t timestamp)
{
    vector<uint8_t> buffer;
...
void SecureSubscriberConnection::ReadCommandChannel()
{
    if (m_stopped)
        return;
...
void SecureSubscriberConnection::ReadPayloadHeader(const ErrorCode& error, const size_t bytesTransferred)
{
    if (m_stopped)
        return;
...
void SecureSubscriberConnection::ParseCommand(const ErrorCode& error, const size_t bytesTransferred)
{
...
std::vector<uint8_t> SecureSubscriberConnection::SerializeSignalIndexCache(SignalIndexCache& signalIndexCache) const
{
...
std::vector<uint8_t> SecureSubscriberConnection::SerializeMetadata(const sttp::data::DataSetPtr& metadata) const
{
    vector<uint8_t> serializationBuffer;
...
DataSetPtr SecureSubscriberConnection::FilterClientMetadata(const StringMap<ExpressionTreePtr>& filterExpressions) const
{
...
void SecureSubscriberConnection::CommandChannelSendAsync()
{
    if (m_stopped)
        return;
...
void SecureSubscriberConnection::CommandChannelWriteHandler(const ErrorCode& error, const size_t bytesTransferred)
{
    if (m_stopped)
        return;
...
void SecureSubscriberConnection::DataChannelSendAsync()
{
    if (m_stopped)
        return;
...
void SecureSubscriberConnection::DataChannelWriteHandler(const ErrorCode& error, const size_t bytesTransferred)
{
    if (m_stopped)
        return;
...
bool SecureSubscriberConnection::SendResponse(const uint8_t responseCode, const uint8_t commandCode)
{
    return SendResponse(responseCode, commandCode, vector<uint8_t>(0));
}

bool SecureSubscriberConnection::SendResponse(const uint8_t responseCode, const uint8_t commandCode, const string& message)
{
    const vector<uint8_t> data = EncodeString(message);
    return SendResponse(responseCode, commandCode, data);
}

bool SecureSubscriberConnection::SendResponse(const uint8_t responseCode, const uint8_t commandCode, const vector<uint8_t>& data)
{
    bool success = false;
...
string SecureSubscriberConnection::DecodeString(const uint8_t* data, const uint32_t offset, const uint32_t length) const
{
...
vector<uint8_t> SecureSubscriberConnection::EncodeString(const string& value) const
{
    // On Windows sizeof(wchar_t) == 2 and on Linux and OS X sizeof(wchar_t) == 4, so we do not use
    // sizeof(wchar_t) to infer number of encoded bytes per wchar_t, which is always 2:
    static const uint32_t enc_sizeof_wchar = 2;
...
void SecureSubscriberConnection::PingTimerElapsed(Timer*, void* userData)
{
    SecureSubscriberConnection* connection = static_cast<SecureSubscriberConnection*>(userData);
